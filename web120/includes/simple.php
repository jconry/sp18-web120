...
#EDIT THE FOLLOWING:
$toAddress = "jenconry@gmail.com";  //place your/your client's email address here
$toName = "Jennifer"; //place your client's name here
$website = "jenniferconry.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>We'll respond via email within 48 hours, if you requested information requires a response</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
